...
const string ANOTHER_HEAT_MAP =
    "Do you want to create another heat map? (yes/no): ";
const string ASK_IF_HEAT_MAP = "Do you want to create a heat map? (yes/no): ";
const string ASK_IF_POLARIZED =
    "Do you want to create a polarized field? (yes/no): ";
const string WHAT_POLARIZATION_TYPE =
    "What type of polarization do you want? (normal/complete): \n"
    "\t - normal: allows both directions to contribute to the field\n"
    "\t - complete: only allows one direction to contribute to the field\n";
const string WHAT_POLARIZATION_DIR = "What direction do you want to polarize the field? (S,SE,E,NE,N,NW,W,SW):";
const string ENTER_PPM_FILE_NAME = "* enter PPM output file name: ";
const string WRITING_PPM_FILE = "* writing PPM file... ";
const string PPM_FILE_CREATED = "* PPM file sucessfully created. ";
...
const bool OUTPUT_VALIDATION = false;
...
// ppm_stream flags
const bool HEAT_MAP = false;
const bool SIGMOID = false;
const bool LINE = false;
const bool FIELD_MAP_RGB = false;
}  // namespace debug_flags
   // =----------------- END OF CONSTANTS -----------------=
   // ------------------------------------------------------
